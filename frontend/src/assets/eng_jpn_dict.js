export const dict = {
  en: {
    title: { title: "Kayko Ohkawa | My Site" },
    nav: { about: "about me", cv: "curriculum vitae", contact: "contact" },
    about: { 
  ...
  ja: {
    title: { title: "Kayko Ohkawa | マイサイト" },
    nav: { about: "自己紹介", cv: "履歴書", contact: "連絡先" },
    about: { 
      intro: "<fg t='オオカワ・ケイコ'>Kayko Ohkawa</fg>と申します。データサイエンティストとして4年間の経験を有し、現在、アメリカ合衆国ピッツバーグに本社を置くPNC銀行の顧客・マーケティング分析部門で勤務しております。", 
      body: [
        "学問的背景は経済学、地質学、データサイエンスに及びます。これらは通常並列される分野ではありませんが、組み合わせることで幅広い問題解決ツールキットを提供してくれます。専門的には、データパイプライン全体（粗削りで生の状態から戦略を推進する洞察の創出まで）をカバーする効率的で拡張性のあるワークフロー構築に特に興味を持っています。",
        "仕事以外では、同じ好奇心が私を様々な方向へと導きます。ボルダリング、日本語学習、そして犬や猫だけでなく魚や蛇も飼うペットの世話に励んでいます。NASAR認定の捜索救助（SAR）と野外救急法の資格を持ち、ボランティア活動を通じてアパラチアの丘や森を楽しみながら他者を支援しています。また、ゲームやファンタジー世界も好み、これらは創造的な問題解決と探求への愛を育んでくれます。",
